...
public class StubMenuLower extends Activity{
	ListView listView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.stubmenulower);
	...
	}else
	{
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
              ...
              if(position%(AMOUNT_OF_VIEWS*amtIteration) == 0 && position != 0 && position < ourStack.getTopIndex()){
                	...
                	Intent openMapMarker = new Intent(StubMenuLower.this, IndividualMapMarker.class);
			...
			public void onClick(View v) {
				...
				if(provider != null){
					...
					if(lastknownloc != null){
				        ...
				        // Forth - the Array of data
				        list = new ArrayList<String>(Arrays.asList(values));
				        adapter = new ArrayAdapter<String>(StubMenuLower.this,
				                R.layout.listlayout, R.id.txtIcon, list);
